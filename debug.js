...
const fixedCookies = [ // ← 固定Cookie埋め込み式
  {
    name: 'AWSALBTG',
    value: 'UOUwuWcvE30QX0Dp2UZz02Hqo1xmq2IdFwVQmJKSnKLUmqiMWq4VJU4laPL96Zp8fgN43NLOtBb2knWFvgFZ0fsJtnFUZWFaCZP9BbczzSAMwUDdEiTRqaqy3tS/KbMuKpSouoIqNLGXuu1CCdrUiy3IykCsn86NEQ/SgYdTsQoQIwX8UBQ=',
    domain: 'as.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: false, httpOnly: false, session: false
  },
  {
    name: '_ga', value: 'GA1.1.581626692.1752773516',
    domain: '.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: false, httpOnly: false, session: false
  },
  {
    name: '_src_session', value: 'ba8771f87cf957b44180d6a26f34e3c9',
    domain: 'as.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: true, httpOnly: true, session: true
  },
  {
    name: '_ga_YHTH3JM9GY', value: 'GS2.1.s1752801973$o3$g1$t1752801986$j47$l0$h0',
    domain: '.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: false, httpOnly: false, session: false
  },
  {
    name: '_ga_R7KBSKLL21', value: 'GS2.1.s1752801973$o3$g1$t1752801986$j47$l0$h0',
    domain: '.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: false, httpOnly: false, session: false
  },
  {
    name: 'AWSALB', value: 'TsV6zFyXZ+KXdjtTbbEruWkMs8rG8tMrwoZ/R3iOtzXFW/X333ldHzyMM5Q9EG0EsvjNQitCtPrGaoG6I4zyXrFnJRRsi4jpfbvOKxcJEnpZfVtaKpCJXs66iMQM',
    domain: 'as.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: false, httpOnly: false, session: false
  },
  {
    name: 'AWSALBCORS', value: 'TsV6zFyXZ+KXdjtTbbEruWkMs8rG8tMrwoZ/R3iOtzXFW/X333ldHzyMM5Q9EG0EsvjNQitCtPrGaoG6I4zyXrFnJRRsi4jpfbvOKxcJEnpZfVtaKpCJXs66iMQM',
    domain: 'as.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: true, httpOnly: false, session: false
  },
  {
    name: 'AWSALBTGCORS', value: 'UOUwuWcvE30QX0Dp2UZz02Hqo1xmq2IdFwVQmJKSnKLUmqiMWq4VJU4laPL96Zp8fgN43NLOtBb2knWFvgFZ0fsJtnFUZWFaCZP9BbczzSAMwUDdEiTRqaqy3tS/KbMuKpSouoIqNLGXuu1CCdrUiy3IykCsn86NEQ/SgYdTsQoQIwX8UBQ=',
    domain: 'as.its-kenpo.or.jp',
    path: '/', sameSite: 'no_restriction', secure: true, httpOnly: false, session: false
  }
];
